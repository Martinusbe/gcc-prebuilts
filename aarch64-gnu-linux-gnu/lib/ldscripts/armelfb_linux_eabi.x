...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/nathan/Toolchains/gcc-build/out/aarch64-gnu-linux-gnu/aarch64-gnu-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
